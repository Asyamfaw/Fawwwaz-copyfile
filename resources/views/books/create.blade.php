...
@section('content')
    ...
    <div class="min-h-[80vh] flex flex-col items-center justify-center">
        ...
        <div class="mb-6 text-center">
            <h1 class="text-xl font-bold text-white">Tambah Buku</h1>
            <p class="text-slate-400 text-sm mt-0.5">Tambahkan koleksi buku baru</p>
        </div>
        ...
        <div class="bg-slate-900 border border-slate-700/50 rounded-2xl px-8 py-8 w-full max-w-2xl">
            <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="sinopsis" id="Sinopsis" required placeholder="Tulis sinopsis singkat"
                        class="w-full bg-slate-800 border border-slate-700 text-white placeholder-slate-500 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition" />
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="tahun_terbit" id="TahunTerbit" required placeholder="contoh: 2023"
                        class="w-full bg-slate-800 border border-slate-700 text-white placeholder-slate-500 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition" />
                </div>
