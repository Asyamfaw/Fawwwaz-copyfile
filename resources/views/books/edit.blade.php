        ...
        <div class="w-full max-w-3xl bg-white shadow-xl rounded-2xl p-8">
            <form action="{{ route('books.update', $books->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input type="text" value="{{ $books->judul }}" id="Judul" name="judul"
                ...
                <div>
                    ...
                    <input type="text" value="{{ $books->sinopsis }}" id="Sinopsis" name="sinopsis"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none p-3">
                </div>
                <div>
                    <label for="" class="block mb-2 font-semibold text-gray-700">
                    ...
                    <input type="number" value="{{ $books->tahun_terbit }}" id="TahunTerbit" name="tahun_terbit"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none p-3">
                </div>
                <div>
                    <label for="" class="block mb-2 font-semibold text-gray-700">
