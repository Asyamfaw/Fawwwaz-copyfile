...
<div class="flex bg-gray-900 min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form action="{{ route('auth.actionLogin') }}" method="POST" class="space-y-6">
        @csrf
      <div>
    ...
    <p class="mt-10 text-center text-sm/6 text-gray-400">
      Belum punya akun?
       <a href="{{ route('auth.register') }}" class="font-semibold text-indigo-400 hover:text-indigo-300">Daftar sekarang</a>
    </p>
  </div>
</div>
